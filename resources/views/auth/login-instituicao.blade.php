    ...
    <div class="ml-percent-5 mr-percent-5 flex poppins-regular">
        ...
        <div class="w-1/2 flex flex-col justify-center p-6 bg-[#272727] rounded-xl">
            ...
            <p class="text-gray-400 text-center">
                Entre com suas credenciais e tenha acesso a um sistema intuitivo para gerenciar sua instituição de ensino de forma fácil.
            </p>
            <br>
        ...
        <div class="w-1/2 p-6 inset-shadow-sm inset-shadow-gray-400/90 rounded-xl ml-percent-1">
            <h2 class="text-3xl font-bold text-gray-800 mb-4"><i class="bi bi-buildings"></i> Login da Instituição</h2>
            <br>
