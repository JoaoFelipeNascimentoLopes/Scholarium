...
<br><br><br>
    ...
    <div class="ml-percent-5 mr-percent-5">
        <h1 class="poppins-regular text-2xl justify-self-center"><i class="bi bi-book-half"></i> Nossos Serviços <i class="bi bi-book-half"></i></h1>
        <br>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Card 1 -->
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition inset-shadow-sm inset-shadow-gray-400/90">
                <img src="{{ asset('images/img_CadUser.png') }}" class="w-40 justify-self-center" alt="Cadastro de Alunos">
                <h2 class="text-xl poppins-regular mb-2 text-center">🎓 Gestão de Alunos</h2>
                <p class="poppins-regular text-gray-700 text-center">Cadastre e gerencie alunos de forma simples e eficiente, mantendo um histórico acadêmico completo e acessível.</p>
            </div>
            <!-- Card 2 -->
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition inset-shadow-sm inset-shadow-gray-400/90">
                ...
                <p class="poppins-regular text-gray-700 text-center">Organize e gerencie as turmas, vincule alunos aos professores e defina horários de aula, tudo em um único lugar.</p>
            </div>
            <!-- Card 3 -->
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition inset-shadow-sm inset-shadow-gray-400/90">
                <img src="{{ asset('images/img_Notas.png') }}" class="w-40 justify-self-center" alt="Lançamento de Notas">
                <h2 class="text-xl poppins-regular mb-2 text-center">📝 Lançamento de Notas</h2>
                <p class="poppins-regular text-gray-700 text-center">Registre e acompanhe o desempenho dos alunos com facilidade, gerando relatórios detalhados e boletins escolares.</p>
            </div>
        </div>
    </div>
    <br><br>
