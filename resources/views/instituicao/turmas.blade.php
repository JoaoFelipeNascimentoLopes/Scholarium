...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <title>Turmas - Instituição</title>
    <!-- Fontes -->
    <style>
        .poppins-thin {
...
<body>
    <div class="flex h-screen">
        ...
        <div id="main-content" class="flex-1 ml-64 p-10 content-transition poppins-regular">
            ...
            <h1 class="text-2xl font-bold mb-5"><i class="bi bi-mortarboard"></i> Turmas</h1>
            <p>Aqui você pode gerenciar as Turmas cadastradas em sua Instituição de Ensino.</p><br>
